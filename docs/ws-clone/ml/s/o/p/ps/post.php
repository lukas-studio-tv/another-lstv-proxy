...
fwrite($fp, "<div id='msgline' class='msgln'><p><b>By: ".$_SESSION['name']."</b> Posted on: ".date("g:i A")."<h3>".stripslashes(htmlspecialchars($title))."</h3>".stripslashes(htmlspecialchars($text))."</p></div><br>\n");
}
