...
session_start ();
function loginForm() {
    include($_SERVER['DOCUMENT_ROOT']."/s/o/p/ps/pubsrc/lcss.php");
	echo '
    <div class="center">
    <div id="loginform">
...
<link rel="shortcut icon" href="https://www.lstv.ml/s/msg/openchat/icon.png" type="image/x-icon">
<title>Post</title>
</head>
<body>
	<?php
...
<div id="wrapper">
		<div id="menu">
			<p class="welcome">
            <?php include($_SERVER['DOCUMENT_ROOT']."/s/o/p/ps/pubsrc/h.php"); ?>
			</p><br><br><br><br>
...
<div id='msgline' class='msgln'>
		<form name="message" action="">
			<h3>Add a post</h3><input class="form-field"  style="border-radius: 8px;" name="usertitle" type="text" id="usertitle" size="63" /><br><textarea class="form-field" style="border-radius: 8px;" name="usermsg" type="text" id="usermsg" size="63" /></textarea><br><input
				name="submitmsg" type="submit" id="submitmsg" value="Send" class="submitmsg" />
		</form>
</div></div>
