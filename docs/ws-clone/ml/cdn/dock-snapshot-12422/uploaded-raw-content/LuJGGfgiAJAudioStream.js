...
track.connect(gainNode).connect(panner).connect(filter1).connect(analyser).connect(audioContext.destination);
      ...
      "blocks": [
	    {
          ...
          "arguments": {
            "URL": {
              "type": "string",
              "defaultValue": 'https://s3-us-west-2.amazonaws.com/s.cdpn.io/355309/equalizer.mp3'
            }
          }
        },
		{
